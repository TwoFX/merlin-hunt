...
The puzzle hunt can be completely played on-line using a computer. All official
communication will be via Discord.

There wil be limited amount of space for teams to participate onsite in Karlsruhe (just for the fun of it).
